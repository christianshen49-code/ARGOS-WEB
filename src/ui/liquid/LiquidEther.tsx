...
/**
 * LiquidEther — React Bits component port to TS.
 *
 * Vendor code is a Navier-Stokes fluid simulation in WebGL (advection,
 * divergence, Poisson pressure solve, optional viscosity). All the heavy
 * physics + shader plumbing lives below; retyping the minified-style
 * single-letter symbols, custom shader pass classes, etc. adds zero
 * runtime value, so the file is `@ts-nocheck`. The exported component
 * itself has a proper props interface.
 */
